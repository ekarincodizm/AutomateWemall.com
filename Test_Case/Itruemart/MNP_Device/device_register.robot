...
*** Test Cases ***
TC_iTM_01774 Display active price plan on register step2 of MNP Sim (1 active)
	[Tags]    TC_iTM_01774    handset    ready   regression
...
TC_iTM_01772 Display active price plan on register step2 of MNP device (1 enable / 1 disabled)
	[Tags]    TC_iTM_01772    handset    ready   regression
...
TC_iTM_01775 Display active price plan on register step2 of MNP Sim (2 active)
	[Tags]    TC_iTM_01775    handset    ready   regression
...
TC_iTM_01773 Show error message if no active price plan
	[Tags]  TC_iTM_01773   MNP_Device    ready   regression
