...
*** Test Cases ***
TC_iTM_01764 Display active price plan on Level D - package details link for bundle
    [Tags]    TC_iTM_01764    ready    regression    WLS_Medium
...
TC_iTM_01765 No bundle tab displayed when no active price plan at all
    [Tags]    TC_iTM_01765    ready    regression    WLS_Medium
...
TC_iTM_01767 Display active price plan on Level D - package details link for bundle
    [Tags]    TC_iTM_01767    ready    regression    WLS_Medium
    ${expect_priceplan_shown}    Set Variable    1
...
TC_iTM_01766 Display active price plan on Level D - package details link for bundle
    [Tags]    TC_iTM_01766    ready    regression    WLS_Medium
