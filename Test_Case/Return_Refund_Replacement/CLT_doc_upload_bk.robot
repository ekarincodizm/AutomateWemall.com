...
*** Variables ***
${email-guest}    test_clt_docUpload@domain.com
...
*** Test Cases ***
TC_iTM_02029 TC_iTM_01_Verify that CLT doc upload is shown after cancel order (operation status is not none)
    [Tags]    TC_iTM_01    ready    TC_iTM_02029
...
TC_iTM_02032 TC_iTM_02_Verify that user can upload and preview ID file in CLT doc upload
    [Tags]    TC_iTM_02    ready    TC_iTM_02032
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02033 TC_iTM_03_Verify that user can upload and preview book bank file in CLT doc upload
    [Tags]    TC_iTM_03    ready    TC_iTM_02033
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02034 TC_iTM_04_Verify that user can upload and preview SLIP file in CLT doc upload
    [Tags]    TC_iTM_04    ready    TC_iTM_02034
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02035 TC_iTM_05_Verify that user can upload and preview company book bank file in CLT doc upload
    [Tags]    TC_iTM_05    ready    TC_iTM_02035
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02036 TC_iTM_06_Verify that user can upload and preview company certificate file in CLT doc upload
    [Tags]    TC_iTM_06    ready    TC_iTM_02036
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02037 TC_iTM_07_Verify that user can upload and preview marriage certificate file in CLT doc upload
    [Tags]    TC_iTM_07    ready    TC_iTM_02037
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02038 TC_iTM_08_Verify that user can upload and preview other file in CLT doc upload
    [Tags]    TC_iTM_08    ready    TC_iTM_02038
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02039 TC_iTM_09_Verify that user can upload multiple files in CLT doc upload
    [Tags]    TC_iTM_09    ready    TC_iTM_02039
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02040 TC_iTM_11_Verify that user can delete ID file in CLT doc upload
    [Tags]    TC_iTM_11    ready    TC_iTM_02040
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02041 TC_iTM_12_Verify that user can delete book bank file in CLT doc upload
    [Tags]    TC_iTM_12    ready    TC_iTM_02041
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02042 TC_iTM_13_Verify that user can delete SLIP file in CLT doc upload
    [Tags]    TC_iTM_13    ready    TC_iTM_02042
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02043 TC_iTM_14_Verify that user can delete company book bank file in CLT doc upload
    [Tags]    TC_iTM_14    ready    TC_iTM_02043
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02044 TC_iTM_15_Verify that user can delete company certificate file in CLT doc upload
    [Tags]    TC_iTM_15    ready    TC_iTM_02044
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02045 TC_iTM_16_Verify that user can delete marriage certificate file in CLT doc upload
    [Tags]    TC_iTM_16    ready    TC_iTM_02045
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02046 TC_iTM_17_Verify that user can delete other file in CLT doc upload
    [Tags]    TC_iTM_17    ready    TC_iTM_02046
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02030 TC_iTM_19_[1 file] Verify that user cannot upload file if file size is more than 5MB.
    [Tags]    TC_iTM_19    ready    TC_iTM_02030
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
...
TC_iTM_02031 TC_iTM_22_[1 file] Verify that cannot upload file if file type is not .jpg, .png or .pdf.
    [Tags]    TC_iTM_22    ready    TC_iTM_02031
    ${order_id}    Create Order API - Guest buy single product success with CS
    Create_order.Set Payment Success For CS    ${order_id}
    Log To Console    order_id = ${order_id}
    LOGIN PCMS    ${username}    ${password}
