...
${PCMS_URL}           http://phoenix-pcms.itruemart-dev.com:81
${ITM_URL}            http://phoenix-www.itruemart-dev.com
${PCMS_URL_HTTP}      phoenix-pcms.itruemart-dev.com
${PCMS_PORT}          81
${FMS_API_V1}         api-fms.aden-dev.com
${FMS_API_USERNAME}    warehousepassword
${FMS_API_PASSWORD}    warehousepassword

${PCMS_API_URL}       phoenix-pcms.itruemart-dev.com:81
${PDS_URL_API}        phoenix-pcms.itruemart-dev.com:8080

${API_GATEWAY_HOST}    phoenix-pcms.itruemart-dev.com:8080
${PDS-API-URI}         ${EMPTY}
...
# ${PCMS_URL_SSL}     https://antman-pcms.itruemart-dev.com
