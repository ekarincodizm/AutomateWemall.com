...
${Wemall_URL}     http://docker-www.itruemart-local.com
...
${ITM_MOBILE}     http://alpha-m.wemall-dev.com
${ITM_MOBILE_URL}    http://alpha-m.wemall-dev.com
${ITM_URL_SSL}    fhttps://alpha-www.itruemart-dev.com
${PCMS_URL}       http://docker-pcms.itruemart-local.com:81
${PCMS_URL_HTTP}    docker-pcms.itruemart-local.com:81
${PCMS_URL_API}    docker-pcms.itruemart-local.com:81
${PCMS_API_URL}    docker-pcms.itruemart-local.com:81
${PCMS_URL_SSL}    https://docker-pcms.itruemart-local.com:81
...
${WEMALL_WEB}     http://docker-www.itruemart-local.com
${BUNDLE-CAMPAIGN-ID}    6814
${PRODUCT-REBUILD-STOCK}    product/rebuild-stock
${PRODUCT-REBUILD-STOCK-NO-VARIANT}    product/rebuild-stock-no-variant
${PRODUCT-REBUILD-STOCK-MOBILE}    products/rebuild-mobile-stocks
...
${WEMALL_URL}     http://docker-www.itruemart-local.com
${WEMALL_API}     docker-www.itruemart-local.com
${WEMALL_URL_SSL}    https://docker-www.itruemart-local.com
...
${WEMALL_ITM}     http://docker-www.itruemart-local.com/itruemart
${PROTOCOL}       http
