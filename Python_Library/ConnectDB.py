...
try :
    ...
    dbhost = BuiltIn().get_variable_value("${DB_HOSTNAME}")
    dbuser = BuiltIn().get_variable_value("${DB_USERNAME}")
    dbpass = BuiltIn().get_variable_value("${DB_PASSWORD}")
    dbname = BuiltIn().get_variable_value("${DB_NAME}")
    dbcharset = BuiltIn().get_variable_value("${DB_CHARSET}")
...
# BuiltIn().log_to_console("Host : " + dbhost + " User : " + dbuser + " Pass : " + dbpass + " DB name : " + dbname + " CHARSET : " + dbcharset)
