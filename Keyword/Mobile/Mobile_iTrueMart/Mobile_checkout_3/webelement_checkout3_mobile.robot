...
${Submit_Checkout3_Mobile}    //*[@id="payment-submit-btn"]/div
...
${Checkout3_CCWCardNo_Mobile}    //*[@id="creditnum"]
${Checkout3_CCWMonth_Mobile}    //*[@id="box-credit-card"]/div/div[3]/div/select[1]
${Checkout3_CCWYear_Mobile}    //*[@id="box-credit-card"]/div/div[3]/div/select[2]
${Checkout3_CCWCCV_Mobile}    //*[@id="box-credit-card"]/div/div[4]/div[1]/div/input
...
&{XPATH_CHECKOUT_STEP3}   btn_payment=//*[@id="step3-submit"]
 ...
 ...  rdo_inst_bank_bbl=//input[@data-abbreviation="bbl"]
 ...  tab_ccw=//*[@id="payment-channel-selection"]/li/h2/a[contains(@href, "ccw")]
 ...
 ...  jquery_btn_apply_code=$('.btn-use-coupon').click()
