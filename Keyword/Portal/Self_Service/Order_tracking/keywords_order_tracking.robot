...
SS Order Tracking - Display Not Found Order
...
SS Order Tracking - Display Order Id
    [Arguments]         ${order_id}
...
SS Order Tracking - Display Order Date
    ...
    Should Be Equal                             ${txt_order_date}                   ${order_date_}

SS Order Tracking - Display Order Sub Total
    [Arguments]         ${sub_total}
    ...
    Should Be Equal                             ${txt_sub_total}                    ${sub_total}

SS Order Tracking - Display Order Total Item
    ...
    ${txt_total_item}=                          Convert To Integer                  ${txt_total_item}
    ${total_item}=                              Convert To Integer                  ${total_item}
    Should Be Equal As Integers                  ${txt_total_item}                   ${total_item}

SS Order Tracking - [item] Display Product Name
...
SS Order Tracking - [item] Display Product Image
    [Arguments]         ${item_id}
    ${item_id}=                         Convert To String               ${item_id}
...
SS Order Tracking - [item] Display Product Price
...
SS Order Tracking - [item] Display Product Qty
...
SS Order Tracking - [item] Display Payment Status Customer
...
SS Order Tracking - [item] Display Item Status Customer
...
SS Order Tracking - [item] Display Tracking Details
    [Arguments]         ${item_id}      ${tracking_number}
    ${item_id}=                              Convert To String                          ${item_id}
    ${element_tracking_details}=             Replace String                             ${SS_OrderTracking.item_tracking_details}       REPLACE_ITEM_ID     ${item_id}
    ${element_tracking_btn}=                 Replace String                             ${SS_OrderTracking.item_btn_tracking_no}        REPLACE_ITEM_ID     ${item_id}
    Wait Until Element Is Visible            ${element_tracking_details}                  10s
    Run Keyword IF                           '${tracking_number}' != 'None'             Element Should Be Visible           ${element_tracking_btn}
    ...
    ${fact_title_tracking}=                  Get Text                                   ${element_tracking_details}
    Should Contain                           เลขที่พัสดุ (อ้างอิง) : ${tracking_number}       ${fact_title_tracking}

SS Order Tracking - [item] Display Tracking Number
    [Arguments]         ${item_id}      ${tracking_number}
    ${item_id}=                              Convert To String                          ${item_id}
    ${element_tracking_number}=             Replace String                              ${SS_OrderTracking.item_tracking_details}       REPLACE_ITEM_ID     ${item_id}
...
SS Order Tracking - [item] Display Tracking Number Button
    [Arguments]         ${item_id}
    ${item_id}=                              Convert To String                          ${item_id}
    ${element_tracking_btn}=                 Replace String                             ${SS_OrderTracking.item_btn_tracking_no}        REPLACE_ITEM_ID     ${item_id}
    Element Should Be Visible           ${element_tracking_btn}

SS Order Tracking - [item] Do not Display Tracking Number Button
    [Arguments]         ${item_id}
    ${item_id}=                              Convert To String                          ${item_id}
    ${element_tracking_btn}=                 Replace String                             ${SS_OrderTracking.item_btn_tracking_no}        REPLACE_ITEM_ID     ${item_id}
    Element Should Not Be Visible                ${element_tracking_btn}

SS Order Tracking - [item] Display Estimated Time Shipping
    [Arguments]         ${item_id}
    ${item_id}=                              Convert To String                          ${item_id}
...
SS Order Tracking - Display Item Details
    ...
    \           SS Order Tracking - [item] Display Product Name             ${item_id}      ${item_name}
    \           SS Order Tracking - [item] Display Product Image            ${item_id}
    \           SS Order Tracking - [item] Display Product Price            ${item_id}      ${item_price}
    \           SS Order Tracking - [item] Display Product Qty              ${item_id}      ${quantity}
    \           SS Order Tracking - [item] Display Payment Status Customer  ${item_id}      ${payment_status_customer}
    \           SS Order Tracking - [item] Display Item Status Customer     ${item_id}      ${item_status_customer}
    \           SS Order Tracking - [item] Display Tracking Details         ${item_id}      ${tracking_number}
    \           SS Order Tracking - [item] Display Estimated Time Shipping      ${item_id}
...
SS Order Tracking - Click View Tracking
    [Arguments]         ${item_id}
    ${item_id}=                              Convert To String                          ${item_id}
    ${link_tracking}=             Replace String                             ${SS_OrderTracking.item_tracking_details_link}       REPLACE_ITEM_ID     ${item_id}
