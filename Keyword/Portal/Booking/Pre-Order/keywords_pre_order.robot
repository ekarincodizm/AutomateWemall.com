...
Booking Pre-Order Page - Display Page
    Location Should Contain    /iphone-se/pre-order

Booking Pre-Order Page - Display EN Page
    Location Should Contain    /en/iphone-se/pre-order
...
Booking Pre-Order Page - User Select Product Model
    ...
    Booking Pre-Order Page - User Select Product Capacity    ${var_booking_product_size_id}
    Booking Pre-Order Page - User Select Product Color       ${var_booking_product_color_id}

Booking Pre-Order Page - User Select Product Model EN
    Booking Pre-Order Page - Get Product Color And Size      en
    Booking Pre-Order Page - User Select Product Capacity    ${var_booking_product_size_id}
    Booking Pre-Order Page - User Select Product Color       ${var_booking_product_color_id}
